          ...
          <div className={styles.videoSection}>
            <div className={styles.videoContainer}>
              {!project.videoUrl ? (
                ...
                >
                  <div className={styles.videoLabel}>Project Preview</div>
                </div>
              ) : !isVideoVisible ? (
                ...
                <div className={styles.storeLinks}>
                  {project.appStoreUrl && (
                    <a
                      ...
                      className={`${styles.storeLink} ${styles.appStoreLink}`}
                    >
                      App Store
                    </a>
                  )}
                  {project.playStoreUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`${styles.storeLink} ${styles.playStoreLink}`}
                    >
                      Play Store
                    </a>
                  )}
                  {project.websiteUrl && (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className={`${styles.storeLink} ${styles.websiteLink}`}
                    >
                      Website
                    </a>
                  )}
